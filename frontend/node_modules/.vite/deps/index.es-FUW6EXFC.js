...
// node_modules/@walletconnect/sign-client/node_modules/@walletconnect/jsonrpc-ws-connection/dist/esm/utils.js
...
function Ki(r, e) {
  ...
  function p4(c2) {
    ...
    for (var S4 = (_3 - I2) * d2 + 1 >>> 0, b4 = new Uint8Array(S4); I2 !== _3; ) {
      for (var P2 = c2[I2], A2 = 0, C = S4 - 1; (P2 !== 0 || A2 < z2) && C !== -1; C--, A2++)
        P2 += 256 * b4[C] >>> 0, b4[C] = P2 % o >>> 0, P2 = P2 / o >>> 0;
      if (P2 !== 0)
        throw new Error("Non-zero carry");
      z2 = A2, I2++;
    }
    for (var x = S4 - z2; x !== S4 && b4[x] === 0; )
      x++;
    for (var q3 = h4.repeat(m2); x < S4; ++x)
      q3 += r.charAt(b4[x]);
    return q3;
  }
  function y4(c2) {
    ...
    var m2 = 0;
    if (c2[m2] !== " ") {
      for (var z2 = 0, I2 = 0; c2[m2] === h4; )
        z2++, m2++;
      for (var _3 = (c2.length - m2) * u3 + 1 >>> 0, S4 = new Uint8Array(_3); c2[m2]; ) {
        var b4 = t[c2.charCodeAt(m2)];
        if (b4 === 255)
          return;
        for (var P2 = 0, A2 = _3 - 1; (b4 !== 0 || P2 < I2) && A2 !== -1; A2--, P2++)
      ...
      if (c2[m2] !== " ") {
        for (var C = _3 - I2; C !== _3 && S4[C] === 0; )
          C++;
        for (var x = new Uint8Array(z2 + (_3 - C)), q3 = z2; C !== _3; )
          x[q3++] = S4[C++];
        return x;
      }
    }
...
var et2 = import_time.ONE_DAY;
var tt = "keychain";
var it2 = "0.3";
var st2 = "messages";
var rt = "0.3";
var nt2 = import_time.SIX_HOURS;
var at2 = "publisher";
var ot = "irn";
var ht = "error";
...
var lt2 = import_time.ONE_SECOND;
var dt2 = "2.10.2";
var gt = 1e4;
var pt2 = "0.3";
...
var mt2 = "0.3";
var bt2 = import_time.FIVE_SECONDS * 1e3;
var ft2 = "pairing";
var Et = "0.3";
var F = { wc_pairingDelete: { req: { ttl: import_time.ONE_DAY, prompt: false, tag: 1e3 }, res: { ttl: import_time.ONE_DAY, prompt: false, tag: 1001 } }, wc_pairingPing: { req: { ttl: import_time.THIRTY_SECONDS, prompt: false, tag: 1002 }, res: { ttl: import_time.THIRTY_SECONDS, prompt: false, tag: 1003 } }, unregistered_method: { req: { ttl: import_time.ONE_DAY, prompt: false, tag: 0 }, res: { ttl: import_time.ONE_DAY, prompt: false, tag: 0 } } };
...
var Rt = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.keychain = /* @__PURE__ */ new Map(), this.name = tt, this.version = it2, this.initialized = false, this.storagePrefix = O, this.init = async () => {
      if (!this.initialized) {
...
var St = class extends a {
  constructor(e, t) {
    super(e, t), this.logger = e, this.core = t, this.messages = /* @__PURE__ */ new Map(), this.name = st2, this.version = rt, this.initialized = false, this.storagePrefix = O, this.init = async () => {
      if (!this.initialized) {
...
var Dr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events4.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time.toMiliseconds)(import_time.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      var a2;
      this.logger.debug("Publishing Payload"), this.logger.trace({ type: "method", method: "publish", params: { topic: i2, message: s, opts: n2 } });
      try {
        const o = (n2 == null ? void 0 : n2.ttl) || nt2, h4 = mt(n2), u3 = (n2 == null ? void 0 : n2.prompt) || false, d2 = (n2 == null ? void 0 : n2.tag) || 0, p4 = (n2 == null ? void 0 : n2.id) || getBigIntRpcId().toString(), y4 = { topic: i2, message: s, opts: { ttl: o, relay: h4, prompt: u3, tag: d2, id: p4 } }, $3 = setTimeout(() => this.queue.set(p4, y4), this.publishTimeout);
        try {
          await await it(this.rpcPublish(i2, s, o, h4, u3, d2, p4), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p4), this.relayer.events.emit(D2.publish, y4);
        } catch (c2) {
  ...
  rpcPublish(e, t, i2, s, n2, a2, o) {
    ...
    return w((h4 = y4.params) == null ? void 0 : h4.prompt) && ((u3 = y4.params) == null || delete u3.prompt), w((d2 = y4.params) == null ? void 0 : d2.tag) && ((p4 = y4.params) == null || delete p4.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y4 }), this.relayer.request(y4);
  }
...
var xt2 = class extends d {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new yr(), this.events = new import_events4.EventEmitter(), this.name = yt2, this.version = mt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = O, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
      ...
      const a2 = new import_time.Watch();
...
var zt2 = class extends g {
  ...
  attemptToReconnect() {
    ...
    }, (0, import_time.toMiliseconds)(lt2)));
  }
  isInitialized() {
    if (!this.initialized) {
      const { message: e } = N("NOT_INITIALIZED", this.name);
...
var $t2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = ft2, this.version = Et, this.events = new import_events4.default(), this.initialized = false, this.storagePrefix = O, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i2 = Dn(), s = await this.core.crypto.setSymKey(i2), n2 = lt(import_time.FIVE_MINUTES), a2 = { protocol: ot }, o = { topic: s, expiry: n2, relay: a2, active: false }, h4 = Nt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i2, relay: a2 });
      ...
      const h4 = lt(import_time.FIVE_MINUTES), u3 = { topic: s, relay: a2, expiry: h4, active: false };
      ...
      this.isInitialized();
      const s = lt(import_time.THIRTY_DAYS);
...
var Mt2 = class extends h3 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = wt, this.version = vt, this.cached = [], this.initialized = false, this.storagePrefix = O, this.init = async () => {
      ...
      if (this.isInitialized(), this.logger.debug("Setting JSON-RPC request history record"), this.logger.trace({ type: "method", method: "set", topic: i2, request: s, chainId: n2 }), this.records.has(s.id))
        return;
      const a2 = { id: s.id, topic: i2, request: { method: s.method, params: s.params || null }, chainId: n2, expiry: lt(import_time.THIRTY_DAYS) };
  ...
  cleanup() {
    try {
      this.records.forEach((e) => {
        (0, import_time.toMiliseconds)(e.expiry || 0) - Date.now() <= 0 && (this.logger.info(`Deleting expired history log: ${e.id}`), this.delete(e.topic, e.id));
      });
    } catch (e) {
      this.logger.warn(e);
    }
...
var kt2 = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events4.EventEmitter(), this.name = It, this.version = Ct, this.cached = [], this.initialized = false, this.storagePrefix = O, this.init = async () => {
  ...
  checkExpiry(e, t) {
    const { expiry: i2 } = t;
    (0, import_time.toMiliseconds)(i2) - Date.now() <= 0 && this.expire(e, t);
  }
  expire(e, t) {
...
var Kt2 = class extends y {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Q, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async () => {
      ...
      const n2 = this.startAbortTimer(import_time.ONE_SECOND * 2), a2 = await fetch(`${s}/attestation/${i2}`, { signal: this.abortController.signal });
      ...
      }, (0, import_time.toMiliseconds)(import_time.FIVE_SECONDS)))]);
    }, this.removeIframe = () => {
  ...
  startAbortTimer(e) {
    return this.abortController = new AbortController(), setTimeout(() => this.abortController.abort(), (0, import_time.toMiliseconds)(e));
  }
};
...
var ee2 = class _ee extends n {
  constructor(e) {
    ...
    this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new _t(this, this.logger, e == null ? void 0 : e.keychain), this.history = new Mt2(this, this.logger), this.expirer = new kt2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h(qt2(qt2({}, Qe), e == null ? void 0 : e.storageOptions)), this.relayer = new zt2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new $t2(this, this.logger), this.verify = new Kt2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new _ee(e);
    await t.initialize();
...
var ae = "session";
var A = import_time2.SEVEN_DAYS;
var ce2 = "engine";
var V2 = { wc_sessionPropose: { req: { ttl: import_time2.FIVE_MINUTES, prompt: true, tag: 1100 }, res: { ttl: import_time2.FIVE_MINUTES, prompt: false, tag: 1101 } }, wc_sessionSettle: { req: { ttl: import_time2.FIVE_MINUTES, prompt: false, tag: 1102 }, res: { ttl: import_time2.FIVE_MINUTES, prompt: false, tag: 1103 } }, wc_sessionUpdate: { req: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1104 }, res: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1105 } }, wc_sessionExtend: { req: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1106 }, res: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1107 } }, wc_sessionRequest: { req: { ttl: import_time2.FIVE_MINUTES, prompt: true, tag: 1108 }, res: { ttl: import_time2.FIVE_MINUTES, prompt: false, tag: 1109 } }, wc_sessionEvent: { req: { ttl: import_time2.FIVE_MINUTES, prompt: true, tag: 1110 }, res: { ttl: import_time2.FIVE_MINUTES, prompt: false, tag: 1111 } }, wc_sessionDelete: { req: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1112 }, res: { ttl: import_time2.ONE_DAY, prompt: false, tag: 1113 } }, wc_sessionPing: { req: { ttl: import_time2.THIRTY_SECONDS, prompt: false, tag: 1114 }, res: { ttl: import_time2.THIRTY_SECONDS, prompt: false, tag: 1115 } } };
var U3 = { min: import_time2.FIVE_MINUTES, max: import_time2.SEVEN_DAYS };
...
var ps2 = class extends S2 {
  constructor(r) {
    super(r), this.name = ce2, this.events = new import_events5.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: I.idle, queue: [] }, this.sessionRequestQueue = { state: I.idle, queue: [] }, this.requestQueueDelay = import_time2.ONE_SECOND, this.init = async () => {
      ...
      const h4 = await this.client.core.crypto.generateKeyPair(), R2 = g3({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a2 ?? [{ protocol: ot }], proposer: { publicKey: h4, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: w3, resolve: T2, done: K2 } = st(import_time2.FIVE_MINUTES, oe3);
      if (this.events.once(ft("session_connect"), async ({ error: v3, session: S4 }) => {
        if (v3)
          ...
          await this.client.session.set(S4.topic, B3), await this.setExpiry(S4.topic, S4.expiry), c2 && await this.client.core.pairing.updateMetadata({ topic: c2, metadata: S4.peer.metadata }), T2(B3);
        }
      }), !c2) {
        const { message: v3 } = N("NO_MATCHING_KEY", `connect() pairing topic: ${c2}`);
        throw new Error(v3);
      }
      const L3 = await this.sendRequest({ topic: c2, method: "wc_sessionPropose", params: R2 }), ue2 = lt(import_time2.FIVE_MINUTES);
      ...
      a2 && s && (await this.client.core.pairing.updateMetadata({ topic: a2, metadata: c2.metadata }), await this.sendResult({ id: s, topic: a2, result: { relay: { protocol: t ?? "irn" }, responderPublicKey: h4 } }), await this.client.proposal.delete(s, U("USER_DISCONNECTED")), await this.client.core.pairing.activate({ topic: a2 }));
      ...
      const K2 = b2(g3({}, T2), { topic: w3, pairingTopic: a2, acknowledged: false, self: T2.controller, peer: { publicKey: c2.publicKey, metadata: c2.metadata }, controller: h4 });
      ...
      const { chainId: s, request: t, topic: i2, expiry: n2 } = e, o = payloadId(), { done: a2, resolve: c2, reject: p4 } = st(n2, "Request expired. Please try again.");
      ...
      return n2 && (h4.ttl = n2), o && (h4.id = o), this.client.core.history.set(s, p4), c2 ? (h4.internal = b2(g3({}, h4.internal), { throwOnFailedPublish: true }), await this.client.core.relayer.publish(s, d2, h4)) : this.client.core.relayer.publish(s, d2, h4).catch((R2) => this.client.logger.error(R2)), p4.id;
      ...
      try {
        ...
        const n2 = lt(import_time2.FIVE_MINUTES), o = g3({ id: i2, pairingTopic: e, expiry: n2 }, t);
      ...
      try {
        ...
        const { relay: n2, controller: o, expiry: a2, namespaces: c2, requiredNamespaces: p4, optionalNamespaces: d2, sessionProperties: h4, pairingTopic: R2 } = s.params, w3 = g3({ topic: e, relay: n2, expiry: a2, namespaces: c2, acknowledged: true, pairingTopic: R2, requiredNamespaces: p4, optionalNamespaces: d2, controller: o.publicKey, self: { publicKey: "", metadata: this.client.metadata }, peer: { publicKey: o.publicKey, metadata: o.metadata } }, h4 && { sessionProperties: h4 });
...
(function(C, u3) {
  (function() {
    ...
    var Af = function h4(g5) {
      g5 = g5 == null ? k : Ht2.defaults(k.Object(), g5, Ht2.pick(k, Bo));
      ...
      }(), Te = Nt3.toString, Ef = be.call(M3), yf = k._, Sf = Br("^" + be.call(F3).replace(xr2, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Le2 = ds3 ? g5.Buffer : i2, et3 = g5.Symbol, De2 = g5.Uint8Array, Ls2 = Le2 ? Le2.allocUnsafe : i2, He2 = Rs2(M3.getPrototypeOf, M3), Ds2 = M3.create, Hs2 = Nt3.propertyIsEnumerable, Ne2 = Oe.splice, Ns2 = et3 ? et3.isConcatSpreadable : i2, ne2 = et3 ? et3.iterator : i2, pt3 = et3 ? et3.toStringTag : i2, $e2 = function() {
        try {
          var n2 = mt3(M3, "defineProperty");
          return n2({}, "", {}), n2;
        } catch {
        }
      }(), Of = g5.clearTimeout !== k.clearTimeout && g5.clearTimeout, Rf = A2 && A2.now !== k.Date.now && A2.now, bf = g5.setTimeout !== k.setTimeout && g5.setTimeout, Ue2 = X3.ceil, We2 = X3.floor, Gr = M3.getOwnPropertySymbols, Tf = Le2 ? Le2.isBuffer : i2, $s2 = g5.isFinite, Lf = Oe.join, Df = Rs2(M3.keys, M3), Q4 = X3.max, nn = X3.min, Hf = A2.now, Nf = g5.parseInt, Us2 = X3.random, $f = Oe.reverse, zr = mt3(g5, "DataView"), te3 = mt3(g5, "Map"), Kr = mt3(g5, "Promise"), $t3 = mt3(g5, "Set"), ee3 = mt3(g5, "WeakMap"), re2 = mt3(M3, "create"), Fe2 = ee3 && new ee3(), Ut2 = {}, Uf = wt2(zr), Wf = wt2(te3), Ff = wt2(Kr), Mf = wt2($t3), qf = wt2(ee3), Me2 = et3 ? et3.prototype : i2, ie2 = Me2 ? Me2.valueOf : i2, Ws2 = Me2 ? Me2.toString : i2;
      function a2(n2) {
        if (Y(n2) && !O4(n2) && !(n2 instanceof H2)) {
          if (n2 instanceof Pn)
            return n2;
      ...
      function zf() {
        var n2 = this.__wrapped__.value(), t = this.__dir__, e = O4(n2), r = t < 0, s = e ? n2.length : 0, o = eh(0, s, this.__views__), f3 = o.start, c2 = o.end, l = c2 - f3, v3 = r ? c2 : f3 - 1, _3 = this.__iteratees__, m2 = _3.length, P2 = 0, I2 = nn(l, this.__takeCount__);
        if (!e || !r && s == l && I2 == l)
        ...
        n:
          for (; l-- && P2 < I2; ) {
            v3 += t;
            for (var b4 = -1, y4 = n2[v3]; ++b4 < m2; ) {
              var D4 = _3[b4], N4 = D4.iteratee, dn = D4.type, sn = N4(y4);
              if (dn == $a)
                y4 = sn;
              else if (!sn) {
                if (dn == Bi2)
      ...
      function Fs2(n2, t) {
        var e = O4(n2), r = !e && Pt2(n2), s = !e && !r && at3(n2), o = !e && !r && !s && Bt3(n2), f3 = e || r || s || o, c2 = f3 ? Fr(n2.length, Cf) : [], l = c2.length;
        for (var v3 in n2)
          (t || F3.call(n2, v3)) && !(f3 && (v3 == "length" || s && (v3 == "offset" || v3 == "parent") || o && (v3 == "buffer" || v3 == "byteLength" || v3 == "byteOffset") || Zn(v3, l))) && c2.push(v3);
        return c2;
      }
      function Ms2(n2) {
        var t = n2.length;
      ...
      function An(n2, t, e, r, s, o) {
        var f3, c2 = t & Ln2, l = t & Fn2, v3 = t & xt3;
        ...
        var E4 = v3 ? l ? pi : li : l ? on : V3, b4 = _3 ? i2 : E4(n2);
        return mn(b4 || n2, function(y4, D4) {
          b4 && (D4 = y4, y4 = n2[D4]), se(f3, D4, An(y4, t, e, D4, n2, o));
        }), f3;
      }
      function _c(n2) {
        var t = V3(n2);
      ...
      function ue2(n2, t, e, r) {
        var s = -1, o = Ee2, f3 = true, c2 = n2.length, l = [], v3 = t.length;
        if (!c2)
          return l;
      ...
      function j4(n2, t, e, r, s) {
        ...
        for (e || (e = ah), s || (s = []); ++o < f3; ) {
          var c2 = n2[o];
          t > 0 && e(c2) ? t > 1 ? j4(c2, t - 1, e, r, s) : nt3(s, c2) : r || (s[s.length] = c2);
        }
        return s;
      }
      ...
      function Vr(n2, t, e) {
        for (var r = e ? Dr2 : Ee2, s = n2[0].length, o = n2.length, f3 = o, c2 = p4(o), l = 1 / 0, v3 = []; f3--; ) {
          var _3 = n2[f3];
          f3 && t && (_3 = G3(_3, hn(t))), l = nn(_3.length, l), c2[f3] = !e && (t || s >= 120 && _3.length >= 120) ? new gt2(f3 && _3) : i2;
        }
        _3 = n2[0];
        var m2 = -1, P2 = c2[0];
        n:
          for (; ++m2 < s && v3.length < l; ) {
            ...
            if (I2 = e || I2 !== 0 ? I2 : 0, !(P2 ? jt3(P2, E4) : r(v3, E4, e))) {
              for (f3 = o; --f3; ) {
                var b4 = c2[f3];
                if (!(b4 ? jt3(b4, E4) : r(n2[f3], E4, e)))
                  continue n;
              }
              P2 && P2.push(E4), v3.push(I2);
            }
          }
        return v3;
      }
      ...
      function yc(n2, t, e, r, s, o) {
        var f3 = O4(n2), c2 = O4(t), l = f3 ? me2 : tn(n2), v3 = c2 ? me2 : tn(t);
        l = l == Ot2 ? qn : l, v3 = v3 == Ot2 ? qn : v3;
        ...
        if (P2 && !_3)
          return o || (o = new Rn2()), f3 || Bt3(n2) ? Su(n2, t, e, r, s, o) : jc(n2, t, l, e, r, s, o);
        if (!(e & Et2)) {
      ...
      function kr(n2, t, e, r) {
        ...
        for (; ++s < o; ) {
          ...
          if (f3 && c2[2]) {
            ...
            var m2 = new Rn2();
            if (r)
              var P2 = r(v3, _3, l, n2, t, m2);
            if (!(P2 === i2 ? oe4(_3, v3, Et2 | ve2, r, m2) : P2))
              return false;
          }
        }
        return true;
      ...
      function Qs2(n2) {
        return typeof n2 == "function" ? n2 : n2 == null ? fn : typeof n2 == "object" ? O4(n2) ? js2(n2[0], n2[1]) : ks2(n2) : ma(n2);
      }
      function jr(n2) {
        if (!he3(n2))
          return Df(n2);
      ...
      function Lc(n2, t, e, r, s, o, f3) {
        var c2 = wi(n2, e), l = wi(t, e), v3 = f3.get(l);
        if (v3) {
          Yr(n2, e, v3);
          return;
        }
        ...
        if (m2) {
          var P2 = O4(l), I2 = !P2 && at3(l), E4 = !P2 && !I2 && Bt3(l);
          _3 = l, P2 || I2 || E4 ? O4(c2) ? _3 = c2 : Z2(c2) ? _3 = un2(c2) : I2 ? (m2 = false, _3 = hu(l, true)) : E4 ? (m2 = false, _3 = lu(l, true)) : _3 = [] : pe3(l) || Pt2(l) ? (_3 = c2, Pt2(c2) ? _3 = oa(c2) : (!K2(c2) || Jn2(c2)) && (_3 = bu(l))) : m2 = false;
        }
      ...
      function ti(n2, t, e, r) {
        ...
        for (n2 === t && (t = un2(t)), e && (c2 = G3(n2, hn(e))); ++o < f3; )
          for (var l = 0, v3 = t[o], _3 = e ? e(v3) : v3; (l = s(c2, _3, l, r)) > -1; )
      ...
      function fe(n2, t, e, r) {
        ...
        for (var s = -1, o = t.length, f3 = o - 1, c2 = n2; c2 != null && ++s < o; ) {
          ...
          if (s != f3) {
            var _3 = c2[l];
            v3 = r ? r(_3, l, c2) : i2, v3 === i2 && (v3 = K2(_3) ? _3 : Zn(t[s + 1]) ? [] : {});
          }
          se(c2, l, v3), c2 = c2[l];
        }
        return n2;
      ...
      function ii(n2, t, e, r) {
        ...
        if (o === 0)
          return 0;
        t = e(t);
        for (var f3 = t !== t, c2 = t === null, l = pn(t), v3 = t === i2; s < o; ) {
          var _3 = We2((s + o) / 2), m2 = e(n2[_3]), P2 = m2 !== i2, I2 = m2 === null, E4 = m2 === m2, b4 = pn(m2);
          if (f3)
            var y4 = r || E4;
          else
            v3 ? y4 = E4 && (r || P2) : c2 ? y4 = E4 && P2 && (r || !I2) : l ? y4 = E4 && P2 && !I2 && (r || !b4) : I2 || b4 ? y4 = false : y4 = r ? m2 <= t : m2 < t;
          y4 ? s = _3 + 1 : o = _3;
        }
        return nn(o, Fa);
      }
      ...
      function st3(n2, t) {
        return O4(n2) ? n2 : _i(n2, t) ? [n2] : Wu(W3(n2));
      }
      var qc = L3;
      function ut3(n2, t, e) {
        var r = n2.length;
      ...
      function pu(n2, t) {
        if (n2 !== t) {
          var e = n2 !== i2, r = n2 === null, s = n2 === n2, o = pn(n2), f3 = t !== i2, c2 = t === null, l = t === t, v3 = pn(t);
          if (!c2 && !v3 && !o && n2 > t || o && f3 && l && !c2 && !v3 || r && f3 && l || !e && l || !s)
            return 1;
          if (!r && !o && !v3 && n2 < t || v3 && e && s && !r && !o || c2 && e && s || !f3 && s || !l)
            return -1;
        }
        return 0;
      }
      ...
      function du(n2, t, e, r) {
        for (var s = -1, o = n2.length, f3 = e.length, c2 = -1, l = t.length, v3 = Q4(o - f3, 0), _3 = p4(l + v3), m2 = !r; ++c2 < l; )
          _3[c2] = t[c2];
        for (; ++s < f3; )
          (m2 || s < o) && (_3[e[s]] = n2[s]);
        for (; v3--; )
      ...
      function gu(n2, t, e, r) {
        for (var s = -1, o = n2.length, f3 = -1, c2 = e.length, l = -1, v3 = t.length, _3 = Q4(o - c2, 0), m2 = p4(_3 + v3), P2 = !r; ++s < _3; )
          m2[s] = n2[s];
        for (var I2 = s; ++l < v3; )
          m2[I2 + l] = t[l];
        for (; ++f3 < c2; )
      ...
      function Xc(n2, t, e) {
        var r = ce3(n2);
        function s() {
          for (var o = arguments.length, f3 = p4(o), c2 = o, l = qt3(s); c2--; )
            f3[c2] = arguments[c2];
          var v3 = o < 3 && f3[0] !== l && f3[o - 1] !== l ? [] : tt2(f3, l);
          if (o -= v3.length, o < e)
      ...
      function Pu(n2) {
        return Yn(function(t) {
          ...
          for (r = f3 ? r : e; ++r < e; ) {
            ...
            l && mi(l[0]) && l[1] == (Mn2 | Dn2 | Hn | Kt3) && !l[4].length && l[9] == 1 ? f3 = f3[je3(l[0])].apply(f3, l[3]) : f3 = o.length == 1 && mi(o) ? f3[c2]() : f3.thru(o);
          }
          return function() {
            var v3 = arguments, _3 = v3[0];
            if (f3 && v3.length == 1 && O4(_3))
      ...
      function Xe3(n2, t, e, r, s, o, f3, c2, l, v3) {
        var _3 = t & Mn2, m2 = t & vn, P2 = t & ct3, I2 = t & (Dn2 | yt3), E4 = t & dr, b4 = P2 ? i2 : ce3(n2);
        function y4() {
          for (var D4 = arguments.length, N4 = p4(D4), dn = D4; dn--; )
            N4[dn] = arguments[dn];
          if (I2)
            var sn = qt3(y4), gn = af(N4, sn);
          if (r && (N4 = du(N4, r, s, I2)), o && (N4 = gu(N4, o, f3, I2)), D4 -= gn, I2 && D4 < v3) {
            var J2 = tt2(N4, sn);
            return Iu(n2, t, Xe3, y4.placeholder, e, N4, J2, c2, l, v3 - D4);
          }
          var Tn = m2 ? e : this, Qn = P2 ? Tn[n2] : n2;
          return D4 = N4.length, c2 ? N4 = gh(N4, c2) : E4 && D4 > 1 && N4.reverse(), _3 && l < D4 && (N4.length = l), this && this !== k && this instanceof y4 && (Qn = b4 || ce3(Qn)), Qn.apply(Tn, N4);
        }
        return y4;
      }
      function Au(n2, t) {
      ...
      function ci(n2) {
        return Yn(function(t) {
          return t = G3(t, hn(x())), L3(function(e) {
            var r = this;
      ...
      function Qc(n2, t, e, r) {
        var s = t & vn, o = ce3(n2);
        function f3() {
          for (var c2 = -1, l = arguments.length, v3 = -1, _3 = r.length, m2 = p4(_3 + l), P2 = this && this !== k && this instanceof f3 ? o : n2; ++v3 < _3; )
            m2[v3] = r[v3];
          for (; l--; )
            m2[v3++] = arguments[++c2];
      ...
      function Iu(n2, t, e, r, s, o, f3, c2, l, v3) {
        var _3 = t & Dn2, m2 = _3 ? f3 : i2, P2 = _3 ? i2 : f3, I2 = _3 ? o : i2, E4 = _3 ? i2 : o;
        t |= _3 ? Hn : St2, t &= ~(_3 ? St2 : Hn), t & qi2 || (t &= ~(vn | ct3));
        var b4 = [n2, t, s, I2, m2, E4, P2, c2, l, v3], y4 = e.apply(i2, b4);
        return mi(n2) && Nu(y4, b4), y4.placeholder = r, $u(y4, n2, t);
      }
      function hi(n2) {
        var t = X3[n2];
        return function(e, r) {
      ...
      function Kn2(n2, t, e, r, s, o, f3, c2) {
        ...
        if (!l && typeof n2 != "function")
          throw new wn($3);
        var v3 = r ? r.length : 0;
        if (v3 || (t &= ~(Hn | St2), r = s = i2), f3 = f3 === i2 ? f3 : Q4(R2(f3), 0), c2 = c2 === i2 ? c2 : R2(c2), v3 -= s ? s.length : 0, t & St2) {
          var _3 = r, m2 = s;
          r = s = i2;
        }
        var P2 = l ? i2 : di(n2), I2 = [n2, t, e, r, s, _3, m2, o, f3, c2];
        if (P2 && lh(I2, P2), n2 = I2[0], t = I2[1], e = I2[2], r = I2[3], s = I2[4], c2 = I2[9] = I2[9] === i2 ? l ? 0 : n2.length : Q4(I2[9] - v3, 0), !c2 && t & (Dn2 | yt3) && (t &= ~(Dn2 | yt3)), !t || t == vn)
          var E4 = Jc(n2, t, e);
        else
          t == Dn2 || t == yt3 ? E4 = Xc(n2, t, c2) : (t == Hn || t == (vn | Hn)) && !s.length ? E4 = Qc(n2, t, e, r) : E4 = Xe3.apply(i2, I2);
        var b4 = P2 ? iu : Nu;
      ...
      function Su(n2, t, e, r, s, o) {
        var f3 = e & Et2, c2 = n2.length, l = t.length;
        if (c2 != l && !(f3 && l > c2))
          return false;
        ...
        for (o.set(n2, t), o.set(t, n2); ++m2 < c2; ) {
          ...
          if (I2) {
            if (!Nr(t, function(D4, N4) {
              if (!jt3(I2, N4) && (E4 === D4 || s(E4, D4, e, r, o)))
                return I2.push(N4);
            })) {
              P2 = false;
              break;
      ...
      function nh(n2, t, e, r, s, o) {
        var f3 = e & Et2, c2 = li(n2), l = c2.length, v3 = li(t), _3 = v3.length;
        if (l != _3 && !f3)
          return false;
        for (var m2 = l; m2--; ) {
          var P2 = c2[m2];
        ...
        for (var y4 = f3; ++m2 < l; ) {
          P2 = c2[m2];
          var D4 = n2[P2], N4 = t[P2];
          if (r)
            var dn = f3 ? r(N4, D4, P2, t, n2, o) : r(D4, N4, P2, n2, t, o);
          if (!(dn === i2 ? D4 === N4 || s(D4, N4, e, r, o) : dn)) {
            b4 = false;
            break;
          }
      ...
      function Ru(n2, t, e) {
        ...
        return o || ++r != s ? o : (s = n2 == null ? 0 : n2.length, !!s && ar2(s) && Zn(f3, s) && (O4(n2) || Pt2(n2)));
      }
      function ih(n2) {
...
`);
      ...
      function ah(n2) {
        return O4(n2) || Pt2(n2) || !!(Ns2 && n2 && n2[Ns2]);
      }
      function Zn(n2, t) {
        var e = typeof n2;
      ...
      function lh(n2, t) {
        ...
        if (c2) {
          var l = n2[3];
          n2[3] = l ? du(l, c2, t[4]) : c2, n2[4] = l ? tt2(n2[3], It2) : t[4];
        }
        return c2 = t[5], c2 && (l = n2[5], n2[5] = l ? gu(l, c2, t[6]) : c2, n2[6] = l ? tt2(n2[5], It2) : t[6]), c2 = t[7], c2 && (n2[7] = c2), r & Mn2 && (n2[8] = n2[8] == null ? t[8] : nn(n2[8], t[8])), n2[9] == null && (n2[9] = t[9]), n2[0] = t[0], n2[1] = s, n2;
      }
      function ph(n2) {
        var t = [];
        if (n2 != null)
      ...
      function wh() {
        ...
        for (var t = p4(n2 - 1), e = arguments[0], r = n2; r--; )
          t[r - 1] = arguments[r];
        return nt3(O4(e) ? un2(e) : [e], j4(t, 1));
      }
      var Ph = L3(function(n2, t) {
        return Z2(n2) ? ue2(n2, j4(t, 1, Z2, true)) : [];
      }), Ah = L3(function(n2, t) {
        var e = In(t);
        return Z2(e) && (e = i2), Z2(n2) ? ue2(n2, j4(t, 1, Z2, true), x(e, 2)) : [];
      }), Ch = L3(function(n2, t) {
        var e = In(t);
        return Z2(e) && (e = i2), Z2(n2) ? ue2(n2, j4(t, 1, Z2, true), i2, e) : [];
      });
      function Ih(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
      ...
      function Mu(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = e == null ? 0 : R2(e);
        return s < 0 && (s = Q4(r + s, 0)), ye2(n2, x(t, 3), s);
      }
      function qu(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
        if (!r)
          return -1;
        var s = r - 1;
        return e !== i2 && (s = R2(e), s = e < 0 ? Q4(r + s, 0) : nn(s, r - 1)), ye2(n2, x(t, 3), s, true);
      }
      function Bu(n2) {
      ...
      var Dh = L3(function(n2) {
        ...
        return t === In(e) ? t = i2 : e.pop(), e.length && e[0] === n2[0] ? Vr(e, x(t, 2)) : [];
      }), Nh = L3(function(n2) {
        var t = In(n2), e = G3(n2, ai);
      ...
      function kh(n2, t) {
        return n2 && n2.length ? su(n2, x(t, 2)) : [];
      }
      function jh(n2) {
        var t = n2 == null ? 0 : n2.length;
        return t ? Cn(n2, 1, t) : [];
      ...
      var il = L3(function(n2) {
        return it3(j4(n2, 1, Z2, true));
      }), sl = L3(function(n2) {
        var t = In(n2);
        return Z2(t) && (t = i2), it3(j4(n2, 1, Z2, true), x(t, 2));
      }), ul = L3(function(n2) {
        var t = In(n2);
        return t = typeof t == "function" ? t : i2, it3(j4(n2, 1, Z2, true), i2, t);
      });
      function al(n2) {
        return n2 && n2.length ? it3(n2) : [];
      }
      function ol(n2, t) {
        return n2 && n2.length ? it3(n2, x(t, 2)) : [];
      }
      function fl(n2, t) {
      ...
      var cl = L3(function(n2, t) {
        ...
        var t = In(n2);
        return Z2(t) && (t = i2), ui(jn2(n2, Z2), x(t, 2));
      }), pl = L3(function(n2) {
        var t = In(n2);
      ...
      function Ol(n2, t, e) {
        var r = O4(n2) ? As2 : mc;
        return e && rn(n2, t, e) && (t = i2), r(n2, x(t, 3));
      }
      function Rl(n2, t) {
        var e = O4(n2) ? jn2 : Ks2;
        return e(n2, x(t, 3));
      ...
      function ql(n2, t, e) {
        var r = O4(n2) ? Hr : Es2, s = arguments.length < 3;
        return r(n2, x(t, 4), e, s, rt2);
      }
      function Bl(n2, t, e) {
        var r = O4(n2) ? jo : Es2, s = arguments.length < 3;
        return r(n2, x(t, 4), e, s, zs2);
      }
      function Gl(n2, t) {
        var e = O4(n2) ? jn2 : Ks2;
      ...
      function na(n2, t, e) {
        var r, s, o, f3, c2, l, v3 = 0, _3 = false, m2 = false, P2 = true;
        if (typeof n2 != "function")
          throw new wn($3);
        t = xn2(t) || 0, K2(e) && (_3 = !!e.leading, m2 = "maxWait" in e, o = m2 ? Q4(xn2(e.maxWait) || 0, t) : o, P2 = "trailing" in e ? !!e.trailing : P2);
        function I2(J2) {
          var Tn = r, Qn = s;
          return r = s = i2, v3 = J2, f3 = n2.apply(Qn, Tn), f3;
        }
        function E4(J2) {
          return v3 = J2, c2 = le3(D4, t), _3 ? I2(J2) : f3;
        }
        function b4(J2) {
          var Tn = J2 - l, Qn = J2 - v3, wa = t - Tn;
          return m2 ? nn(wa, o - Qn) : wa;
        }
        function y4(J2) {
          var Tn = J2 - l, Qn = J2 - v3;
        ...
        function dn() {
          c2 !== i2 && cu(c2), v3 = 0, r = l = s = c2 = i2;
        }
        function sn() {
          return c2 === i2 ? f3 : N4(ir2());
        }
        function gn() {
          var J2 = ir2(), Tn = y4(J2);
          if (r = arguments, s = this, l = J2, Tn) {
            if (c2 === i2)
              return E4(l);
            if (m2)
              return cu(c2), c2 = le3(D4, t), I2(l);
          }
          return c2 === i2 && (c2 = le3(D4, t)), f3;
        }
      ...
      var tp = qc(function(n2, t) {
        t = t.length == 1 && O4(t[0]) ? G3(t[0], hn(x())) : G3(j4(t, 1), hn(x()));
        var e = t.length;
      ...
      }, O4 = p4.isArray, vp = gs2 ? hn(gs2) : xc;
      function an2(n2) {
      ...
      function Pp(n2) {
        if (n2 == null)
          return true;
        if (an2(n2) && (O4(n2) || typeof n2 == "string" || typeof n2.splice == "function" || at3(n2) || Bt3(n2) || Pt2(n2)))
          return !n2.length;
        var t = tn(n2);
        if (t == yn || t == Sn)
          return !n2.size;
      ...
      function or2(n2) {
        return typeof n2 == "string" || !O4(n2) && Y(n2) && en(n2) == Qt2;
      }
      function pn(n2) {
      ...
      var qp = L3(function(n2, t) {
        ...
        for (s && rn(t[0], t[1], s) && (r = 1); ++e < r; )
          for (var o = t[e], f3 = on(o), c2 = -1, l = f3.length; ++c2 < l; ) {
            ...
            (_3 === i2 || bn(_3, Nt3[v3]) && !F3.call(n2, v3)) && (n2[v3] = o[v3]);
          }
        return n2;
      }), Bp = L3(function(n2) {
      ...
      function Gp(n2, t) {
        return Cs2(n2, x(t, 3), $n);
      }
      function zp(n2, t) {
        return Cs2(n2, x(t, 3), Xr);
      }
      function Kp(n2, t) {
        return n2 == null ? n2 : Jr(n2, x(t, 3), on);
      }
      function Yp(n2, t) {
        return n2 == null ? n2 : Ys2(n2, x(t, 3), on);
      }
      function Zp(n2, t) {
        return n2 && $n(n2, x(t, 3));
      }
      function Jp(n2, t) {
      ...
      function td(n2, t) {
        var e = {};
        return t = x(t, 3), $n(n2, function(r, s, o) {
          zn2(e, t(r, s, o), r);
        }), e;
      }
      function ed(n2, t) {
      ...
      function ha(n2, t) {
        ...
        return t = x(t), eu(n2, e, function(r, s) {
          return t(r, s[0]);
        });
      }
      function ad(n2, t, e) {
      ...
      function Nd(n2, t, e) {
        ...
        var s = fr2({}, t.imports, r.imports, Eu), o = V3(s), f3 = Mr(s, o), c2, l, v3 = 0, _3 = t.interpolate || Ce2, m2 = "__p += '", P2 = Br((t.escape || Ce2).source + "|" + _3.source + "|" + (_3 === Zi2 ? lo : Ce2).source + "|" + (t.evaluate || Ce2).source + "|$", "g"), I2 = "//# sourceURL=" + (F3.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Go + "]") + `
`;
        n2.replace(P2, function(y4, D4, N4, dn, sn, gn) {
          return N4 || (N4 = dn), m2 += n2.slice(v3, gn).replace(Po, cf), D4 && (c2 = true, m2 += `' +
__e(` + D4 + `) +
'`), sn && (l = true, m2 += `';
` + sn + `;
__p += '`), N4 && (m2 += `' +
...
`) + m2 + `return __p
      ...
      function qd(n2, t) {
        ...
        if (f3 && (c2 += l.length - c2), yi(s)) {
          if (n2.slice(c2).search(s)) {
            var v3, _3 = l;
            for (s.global || (s = Br(s.source, W3(Ji2.exec(s)) + "g")), s.lastIndex = 0; v3 = s.exec(_3); )
              var m2 = v3.index;
      ...
      function Li(n2, t, e) {
        ...
        e == null && !(K2(t) && (s.length || !r.length)) && (e = t, t = n2, n2 = this, s = ze3(t, V3(t)));
        ...
        return mn(s, function(c2) {
          ...
          n2[c2] = l, f3 && (n2.prototype[c2] = function() {
            ...
            if (o || v3) {
              ...
              return m2.push({ func: l, args: arguments, thisArg: n2 }), _3.__chain__ = v3, _3;
            }
      ...
      function lg(n2) {
        return O4(n2) ? G3(n2, Wn) : pn(n2) ? [n2] : un2(Wu(W3(n2)));
      }
      function pg(n2) {
        var t = ++xf;
        return W3(n2) + t;
      ...
      function wg(n2, t) {
        return n2 && n2.length ? Ge2(n2, x(t, 2), Qr) : i2;
      }
      function Pg(n2) {
        return xs2(n2, fn);
      }
      ...
      function Ig(n2, t) {
        return n2 && n2.length ? Ge2(n2, x(t, 2), ni) : i2;
      }
      ...
      return a2.after = Ql, a2.ary = Xu, a2.assign = Up, a2.assignIn = fa, a2.assignInWith = fr2, a2.assignWith = Wp, a2.at = Fp, a2.before = Qu, a2.bind = Ii, a2.bindAll = zd, a2.bindKey = Vu, a2.castArray = op, a2.chain = Yu, a2.chunk = _h, a2.compact = mh, a2.concat = wh, a2.cond = Kd, a2.conforms = Yd, a2.constant = bi, a2.countBy = Sl, a2.create = Mp, a2.curry = ku, a2.curryRight = ju, a2.debounce = na, a2.defaults = qp, a2.defaultsDeep = Bp, a2.defer = Vl, a2.delay = kl, a2.difference = Ph, a2.differenceBy = Ah, a2.differenceWith = Ch, a2.drop = Ih, a2.dropRight = xh, a2.dropRightWhile = Eh, a2.dropWhile = yh, a2.fill = Sh, a2.filter = Rl, a2.flatMap = Ll, a2.flatMapDeep = Dl, a2.flatMapDepth = Hl, a2.flatten = Bu, a2.flattenDeep = Oh, a2.flattenDepth = Rh, a2.flip = jl, a2.flow = Jd, a2.flowRight = Xd, a2.fromPairs = bh, a2.functions = Xp, a2.functionsIn = Qp, a2.groupBy = Nl, a2.initial = Lh, a2.intersection = Dh, a2.intersectionBy = Hh, a2.intersectionWith = Nh, a2.invert = kp, a2.invertBy = jp, a2.invokeMap = Ul, a2.iteratee = Ti, a2.keyBy = Wl, a2.keys = V3, a2.keysIn = on, a2.map = rr2, a2.mapKeys = td, a2.mapValues = ed, a2.matches = Qd, a2.matchesProperty = Vd, a2.memoize = sr2, a2.merge = rd, a2.mergeWith = ca, a2.method = kd, a2.methodOf = jd, a2.mixin = Li, a2.negate = ur2, a2.nthArg = tg, a2.omit = id, a2.omitBy = sd, a2.once = np, a2.orderBy = Fl, a2.over = eg, a2.overArgs = tp, a2.overEvery = rg, a2.overSome = ig, a2.partial = xi, a2.partialRight = ta, a2.partition = Ml, a2.pick = ud, a2.pickBy = ha, a2.property = ma, a2.propertyOf = sg, a2.pull = Fh, a2.pullAll = zu, a2.pullAllBy = Mh, a2.pullAllWith = qh, a2.pullAt = Bh, a2.range = ug, a2.rangeRight = ag, a2.rearg = ep, a2.reject = Gl, a2.remove = Gh, a2.rest = rp, a2.reverse = Ai2, a2.sampleSize = Kl, a2.set = od, a2.setWith = fd, a2.shuffle = Yl, a2.slice = zh, a2.sortBy = Xl, a2.sortedUniq = Vh, a2.sortedUniqBy = kh, a2.split = Ld, a2.spread = ip, a2.tail = jh, a2.take = nl, a2.takeRight = tl, a2.takeRightWhile = el, a2.takeWhile = rl, a2.tap = ml, a2.throttle = sp, a2.thru = er3, a2.toArray = ua, a2.toPairs = la, a2.toPairsIn = pa, a2.toPath = lg, a2.toPlainObject = oa, a2.transform = cd, a2.unary = up, a2.union = il, a2.unionBy = sl, a2.unionWith = ul, a2.uniq = al, a2.uniqBy = ol, a2.uniqWith = fl, a2.unset = hd, a2.unzip = Ci, a2.unzipWith = Ku, a2.update = ld, a2.updateWith = pd, a2.values = Gt3, a2.valuesIn = dd, a2.without = cl, a2.words = va, a2.wrap = ap, a2.xor = hl, a2.xorBy = ll, a2.xorWith = pl, a2.zip = dl, a2.zipObject = gl, a2.zipObjectDeep = vl, a2.zipWith = _l, a2.entries = la, a2.entriesIn = pa, a2.extend = fa, a2.extendWith = fr2, Li(a2, a2), a2.add = dg, a2.attempt = _a, a2.camelCase = md, a2.capitalize = da, a2.ceil = gg, a2.clamp = gd, a2.clone = fp, a2.cloneDeep = hp, a2.cloneDeepWith = lp, a2.cloneWith = cp, a2.conformsTo = pp, a2.deburr = ga, a2.defaultTo = Zd, a2.divide = vg, a2.endsWith = wd, a2.eq = bn, a2.escape = Pd, a2.escapeRegExp = Ad, a2.every = Ol, a2.find = bl, a2.findIndex = Mu, a2.findKey = Gp, a2.findLast = Tl, a2.findLastIndex = qu, a2.findLastKey = zp, a2.floor = _g, a2.forEach = Zu, a2.forEachRight = Ju, a2.forIn = Kp, a2.forInRight = Yp, a2.forOwn = Zp, a2.forOwnRight = Jp, a2.get = Si, a2.gt = dp, a2.gte = gp, a2.has = Vp, a2.hasIn = Oi, a2.head = Gu, a2.identity = fn, a2.includes = $l, a2.indexOf = Th, a2.inRange = vd, a2.invoke = nd, a2.isArguments = Pt2, a2.isArray = O4, a2.isArrayBuffer = vp, a2.isArrayLike = an2, a2.isArrayLikeObject = Z2, a2.isBoolean = _p, a2.isBuffer = at3, a2.isDate = mp, a2.isElement = wp, a2.isEmpty = Pp, a2.isEqual = Ap, a2.isEqualWith = Cp, a2.isError = Ei, a2.isFinite = Ip, a2.isFunction = Jn2, a2.isInteger = ea, a2.isLength = ar2, a2.isMap = ra, a2.isMatch = xp, a2.isMatchWith = Ep, a2.isNaN = yp, a2.isNative = Sp, a2.isNil = Rp, a2.isNull = Op, a2.isNumber = ia, a2.isObject = K2, a2.isObjectLike = Y, a2.isPlainObject = pe3, a2.isRegExp = yi, a2.isSafeInteger = bp, a2.isSet = sa, a2.isString = or2, a2.isSymbol = pn, a2.isTypedArray = Bt3, a2.isUndefined = Tp, a2.isWeakMap = Lp, a2.isWeakSet = Dp, a2.join = $h, a2.kebabCase = Cd, a2.last = In, a2.lastIndexOf = Uh, a2.lowerCase = Id, a2.lowerFirst = xd, a2.lt = Hp, a2.lte = Np, a2.max = mg, a2.maxBy = wg, a2.mean = Pg, a2.meanBy = Ag, a2.min = Cg, a2.minBy = Ig, a2.stubArray = Hi2, a2.stubFalse = Ni2, a2.stubObject = og, a2.stubString = fg, a2.stubTrue = cg, a2.multiply = xg, a2.nth = Wh, a2.noConflict = ng, a2.noop = Di, a2.now = ir2, a2.pad = Ed, a2.padEnd = yd, a2.padStart = Sd, a2.parseInt = Od, a2.random = _d, a2.reduce = ql, a2.reduceRight = Bl, a2.repeat = Rd, a2.replace = bd, a2.result = ad, a2.round = Eg, a2.runInContext = h4, a2.sample = zl, a2.size = Zl, a2.snakeCase = Td, a2.some = Jl, a2.sortedIndex = Kh, a2.sortedIndexBy = Yh, a2.sortedIndexOf = Zh, a2.sortedLastIndex = Jh, a2.sortedLastIndexBy = Xh, a2.sortedLastIndexOf = Qh, a2.startCase = Dd, a2.startsWith = Hd, a2.subtract = yg, a2.sum = Sg, a2.sumBy = Og, a2.template = Nd, a2.times = hg, a2.toFinite = Xn, a2.toInteger = R2, a2.toLength = aa, a2.toLower = $d, a2.toNumber = xn2, a2.toSafeInteger = $p, a2.toString = W3, a2.toUpper = Ud, a2.trim = Wd, a2.trimEnd = Fd, a2.trimStart = Md, a2.truncate = qd, a2.unescape = Bd, a2.uniqueId = pg, a2.upperCase = Gd, a2.upperFirst = Ri, a2.each = Zu, a2.eachRight = Ju, a2.first = Gu, Li(a2, function() {
        ...
        s && (a2.prototype[t] = function() {
          var f3 = this.__wrapped__, c2 = r ? [1] : arguments, l = f3 instanceof H2, v3 = c2[0], _3 = l || O4(f3), m2 = function(D4) {
            var N4 = s.apply(a2, nt3([D4], c2));
            return r && P2 ? N4[0] : N4;
          };
          _3 && e && typeof v3 == "function" && v3.length != 1 && (l = _3 = false);
          var P2 = this.__chain__, I2 = !!this.__actions__.length, E4 = o && !P2, b4 = l && !I2;
          if (!o && _3) {
            f3 = b4 ? f3 : new H2(this);
            var y4 = n2.apply(f3, c2);
            return y4.__actions__.push({ func: er3, args: [m2], thisArg: i2 }), new Pn(y4, P2);
          }
    ...
    lt3 ? ((lt3.exports = Ht2)._ = Ht2, Tr2._ = Ht2) : k._ = Ht2;
  }).call(ge2);
})(Ui, Ui.exports);
...
var Vg = class {
  ...
  createHttpProvider(u3, i2) {
    ...
    return new JsonRpcProvider(new esm_default2(d2, z("disableProviderPing")));
  }
};
var kg = class {
  constructor(u3) {
...
var iv = class {
  ...
  createHttpProvider(u3, i2) {
    ...
    return typeof d2 > "u" ? void 0 : new JsonRpcProvider(new esm_default2(d2, z("disableProviderPing")));
  }
};
...
var lr = class _lr {
  constructor(u3) {
    this.events = new import_events7.default(), this.rpcProviders = {}, this.shouldAbortPairingAttempt = false, this.maxPairingAttempts = 10, this.disableProviderPing = false, this.providerOpts = u3, this.logger = typeof (u3 == null ? void 0 : u3.logger) < "u" && typeof (u3 == null ? void 0 : u3.logger) != "string" ? u3.logger : (0, import_logger3.pino)((0, import_logger3.getDefaultLoggerOptions)({ level: (u3 == null ? void 0 : u3.logger) || Ia })), this.disableProviderPing = (u3 == null ? void 0 : u3.disableProviderPing) || false;
  }
...
var O3 = (a2, t, s) => t in a2 ? N3(a2, t, { enumerable: true, configurable: true, writable: true, value: s }) : a2[t] = s;
var p3 = (a2, t) => {
  for (var s in t || (t = {}))
    U4.call(t, s) && O3(a2, s, t[s]);
  if (y3)
    for (var s of y3(t))
      Q3.call(t, s) && O3(a2, s, t[s]);
  return a2;
};
var M2 = (a2, t) => q2(a2, D3(t));
function g4(a2) {
...
function L2(a2) {
  const { chains: t, optionalChains: s, methods: i2, optionalMethods: n2, events: e, optionalEvents: h4, rpcMap: c2 } = a2;
  if (!D(t))
  ...
  const C = (r == null ? void 0 : r.length) && (d2 == null ? void 0 : d2.length) || !s, I2 = { chains: [...new Set(C ? o.chains.concat(s || []) : s)], methods: [...new Set(o.methods.concat(n2 != null && n2.length ? n2 : E3))], events: [...new Set(o.events.concat(h4 != null && h4.length ? h4 : _2))], rpcMap: c2 };
...
var v2 = class _v {
  ...
  getRpcConfig(t) {
    ...
    return { chains: n2 == null ? void 0 : n2.map((l) => this.formatChainId(l)), optionalChains: e.map((l) => this.formatChainId(l)), methods: c2, events: o, optionalMethods: r, optionalEvents: d2, rpcMap: C, showQrModal: !!(t != null && t.showQrModal), qrModalOptions: I2, projectId: t.projectId, metadata: t.metadata };
  }
  buildRpcMap(t, s) {
    const i2 = {};
    return t.forEach((n2) => {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g4(this.rpc.chains) : g4(this.rpc.optionalChains), this.signer = await cv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await import("./dist-PGDRVMV2.js");
        s = i2;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-FUW6EXFC.js.map
