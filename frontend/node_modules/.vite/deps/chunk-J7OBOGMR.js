...
var name, code, encode, decode;
var init_raw = __esm({
  "node_modules/multiformats/esm/src/codecs/raw.js"() {
    init_bytes();
    name = "raw";
    code = 85;
    encode = (node) => coerce(node);
    decode = (data) => coerce(data);
  }
});
...
var init_hasher = __esm({
  "node_modules/multiformats/esm/src/hashes/hasher.js"() {
    init_digest();
    from = ({ name: name3, code: code3, encode: encode6 }) => new Hasher(name3, code3, encode6);
    Hasher = class {
...
var Encoder, Decoder, ComposedDecoder, or, Codec, from2, baseX, decode5, encode3, rfc4648;
var init_base = __esm({
  "node_modules/multiformats/esm/src/bases/base.js"() {
    init_base_x();
    init_bytes();
    ...
    from2 = ({ name: name3, prefix, encode: encode6, decode: decode7 }) => new Codec(name3, prefix, encode6, decode7);
    ...
    decode5 = (string, alphabet2, bitsPerChar, name3) => {
      const codes = {};
...
//# sourceMappingURL=chunk-J7OBOGMR.js.map
